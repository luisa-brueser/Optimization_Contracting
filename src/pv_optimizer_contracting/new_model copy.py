...
model.supply_to_car=Var(model.set_time,model.set_finance_options,model.set_2car, initialize = 0,bounds=(0,2000),within=NonNegativeReals,doc='Supply from Car Battery per timestep per financing option')    
