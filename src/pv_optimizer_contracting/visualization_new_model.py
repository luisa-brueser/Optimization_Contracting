...
data_supply_PV_to_Car={'Model':['Contracting_model'],'Scenario':['Contracting_1'],'Region':'Supply PV to Car','Variable':['Supply'],'Unit':['kW'],
'1':[model.supply_from_PV[1,'Contractor','Car'].value],'2':[model.supply_from_PV[2,'Contractor','Car'].value],'3':[model.supply_from_PV[3,'Contractor','Car'].value],'4':[model.supply_from_PV[4,'Contractor','Car'].value],'5':[model.supply_from_PV[5,'Contractor','Car'].value],'6':[model.supply_from_PV[6,'Contractor','Car'].value],'7':[model.supply_from_PV[7,'Contractor','Car'].value],'8':[model.supply_from_PV[8,'Contractor','Car'].value],
'9':[model.supply_from_PV[9,'Contractor','Car'].value],'10':[model.supply_from_PV[10,'Contractor','Car'].value],'11':[model.supply_from_PV[11,'Contractor','Car'].value],'12':[model.supply_from_PV[12,'Contractor','Car'].value],'13':[model.supply_from_PV[13,'Contractor','Car'].value],'14':[model.supply_from_PV[14,'Contractor','Car'].value],'15':[model.supply_from_PV[15,'Contractor','Car'].value],
'16':[model.supply_from_PV[16,'Contractor','Car'].value],'17':[model.supply_from_PV[17,'Contractor','Car'].value],'18':[model.supply_from_PV[18,'Contractor','Car'].value],'19':[model.supply_from_PV[19,'Contractor','Car'].value],'20':[model.supply_from_PV[20,'Contractor','Car'].value],'21':[model.supply_from_PV[21,'Contractor','Car'].value],'22':[model.supply_from_PV[22,'Contractor','Car'].value],'23':[model.supply_from_PV[23,'Contractor','Car'].value],'24':[model.supply_from_PV[24,'Contractor','Car'].value]}

data_supply_PV_to_Household={'Model':['Contracting_model'],'Scenario':['Contracting_1'],'Region':'Supply PV to Household','Variable':['Supply'],'Unit':['kW'],
'1':[model.supply_from_PV[1,'Contractor','Household'].value],'2':[model.supply_from_PV[2,'Contractor','Household'].value],'3':[model.supply_from_PV[3,'Contractor','Household'].value],'4':[model.supply_from_PV[4,'Contractor','Household'].value],'5':[model.supply_from_PV[5,'Contractor','Household'].value],'6':[model.supply_from_PV[6,'Contractor','Household'].value],'7':[model.supply_from_PV[7,'Contractor','Household'].value],'8':[model.supply_from_PV[8,'Contractor','Household'].value],
'9':[model.supply_from_PV[9,'Contractor','Household'].value],'10':[model.supply_from_PV[10,'Contractor','Household'].value],'11':[model.supply_from_PV[11,'Contractor','Household'].value],'12':[model.supply_from_PV[12,'Contractor','Household'].value],'13':[model.supply_from_PV[13,'Contractor','Household'].value],'14':[model.supply_from_PV[14,'Contractor','Household'].value],'15':[model.supply_from_PV[15,'Contractor','Household'].value],
'16':[model.supply_from_PV[16,'Contractor','Household'].value],'17':[model.supply_from_PV[17,'Contractor','Household'].value],'18':[model.supply_from_PV[18,'Contractor','Household'].value],'19':[model.supply_from_PV[19,'Contractor','Household'].value],'20':[model.supply_from_PV[20,'Contractor','Household'].value],'21':[model.supply_from_PV[21,'Contractor','Household'].value],'22':[model.supply_from_PV[22,'Contractor','Household'].value],'23':[model.supply_from_PV[23,'Contractor','Household'].value],'24':[model.supply_from_PV[24,'Contractor','Household'].value]}

data_supply_PV_to_Grid={'Model':['Contracting_model'],'Scenario':['Contracting_1'],'Region':'Supply PV to Grid','Variable':['Supply'],'Unit':['kW'],
'1':[model.supply_from_PV[1,'Contractor','Electric Grid'].value],'2':[model.supply_from_PV[2,'Contractor','Electric Grid'].value],'3':[model.supply_from_PV[3,'Contractor','Electric Grid'].value],'4':[model.supply_from_PV[4,'Contractor','Electric Grid'].value],'5':[model.supply_from_PV[5,'Contractor','Electric Grid'].value],'6':[model.supply_from_PV[6,'Contractor','Electric Grid'].value],'7':[model.supply_from_PV[7,'Contractor','Electric Grid'].value],'8':[model.supply_from_PV[8,'Contractor','Electric Grid'].value],
'9':[model.supply_from_PV[9,'Contractor','Electric Grid'].value],'10':[model.supply_from_PV[10,'Contractor','Electric Grid'].value],'11':[model.supply_from_PV[11,'Contractor','Electric Grid'].value],'12':[model.supply_from_PV[12,'Contractor','Electric Grid'].value],'13':[model.supply_from_PV[13,'Contractor','Electric Grid'].value],'14':[model.supply_from_PV[14,'Contractor','Electric Grid'].value],'15':[model.supply_from_PV[15,'Contractor','Electric Grid'].value],
'16':[model.supply_from_PV[16,'Contractor','Electric Grid'].value],'17':[model.supply_from_PV[17,'Contractor','Electric Grid'].value],'18':[model.supply_from_PV[18,'Contractor','Electric Grid'].value],'19':[model.supply_from_PV[19,'Contractor','Electric Grid'].value],'20':[model.supply_from_PV[20,'Contractor','Electric Grid'].value],'21':[model.supply_from_PV[21,'Contractor','Electric Grid'].value],'22':[model.supply_from_PV[22,'Contractor','Electric Grid'].value],'23':[model.supply_from_PV[23,'Contractor','Electric Grid'].value],'24':[model.supply_from_PV[24,'Contractor','Electric Grid'].value]}



data_supply_Grid_to_HP={'Model':['Contracting_model'],'Scenario':['Contracting_1'],'Region':'Supply Grid to HP','Variable':['Supply'],'Unit':['kW'],
'1':[model.supply_from_elec_grid[1,'HP'].value],'2':[model.supply_from_elec_grid[2,'HP'].value],'3':[model.supply_from_elec_grid[3,'HP'].value],'4':[model.supply_from_elec_grid[4,'HP'].value],'5':[model.supply_from_elec_grid[5,'HP'].value],'6':[model.supply_from_elec_grid[6,'HP'].value],'7':[model.supply_from_elec_grid[7,'HP'].value],'8':[model.supply_from_elec_grid[8,'HP'].value],
'9':[model.supply_from_elec_grid[9,'HP'].value],'10':[model.supply_from_elec_grid[10,'HP'].value],'11':[model.supply_from_elec_grid[11,'HP'].value],'12':[model.supply_from_elec_grid[12,'HP'].value],'13':[model.supply_from_elec_grid[13,'HP'].value],'14':[model.supply_from_elec_grid[14,'HP'].value],'15':[model.supply_from_elec_grid[15,'HP'].value],
'16':[model.supply_from_elec_grid[16,'HP'].value],'17':[model.supply_from_elec_grid[17,'HP'].value],'18':[model.supply_from_elec_grid[18,'HP'].value],'19':[model.supply_from_elec_grid[19,'HP'].value],'20':[model.supply_from_elec_grid[20,'HP'].value],'21':[model.supply_from_elec_grid[21,'HP'].value],'22':[model.supply_from_elec_grid[22,'HP'].value],'23':[model.supply_from_elec_grid[23,'HP'].value],'24':[model.supply_from_elec_grid[24,'HP'].value]}
...
data_supply_Grid_to_Car={'Model':['Contracting_model'],'Scenario':['Contracting_1'],'Region':'Supply Grid to Car','Variable':['Supply'],'Unit':['kW'],
'1':[model.supply_from_elec_grid[1,'Car'].value],'2':[model.supply_from_elec_grid[2,'Car'].value],'3':[model.supply_from_elec_grid[3,'Car'].value],'4':[model.supply_from_elec_grid[4,'Car'].value],'5':[model.supply_from_elec_grid[5,'Car'].value],'6':[model.supply_from_elec_grid[6,'Car'].value],'7':[model.supply_from_elec_grid[7,'Car'].value],'8':[model.supply_from_elec_grid[8,'Car'].value],
'9':[model.supply_from_elec_grid[9,'Car'].value],'10':[model.supply_from_elec_grid[10,'Car'].value],'11':[model.supply_from_elec_grid[11,'Car'].value],'12':[model.supply_from_elec_grid[12,'Car'].value],'13':[model.supply_from_elec_grid[13,'Car'].value],'14':[model.supply_from_elec_grid[14,'Car'].value],'15':[model.supply_from_elec_grid[15,'Car'].value],
'16':[model.supply_from_elec_grid[16,'Car'].value],'17':[model.supply_from_elec_grid[17,'Car'].value],'18':[model.supply_from_elec_grid[18,'Car'].value],'19':[model.supply_from_elec_grid[19,'Car'].value],'20':[model.supply_from_elec_grid[20,'Car'].value],'21':[model.supply_from_elec_grid[21,'Car'].value],'22':[model.supply_from_elec_grid[22,'Car'].value],'23':[model.supply_from_elec_grid[23,'Car'].value],'24':[model.supply_from_elec_grid[24,'Car'].value]}
...
data_demand_charging={'Model':['Contracting_model'],'Scenario':['Contracting_1'],'Region':'Demand Charging','Variable':['Demand - Charging'],'Unit':['kW'],
...
data_demand_heating={'Model':['Contracting_model'],'Scenario':['Contracting_1'],'Region':'Demand  Heating','Variable':['Demand - Heating'],'Unit':['kW'],
...
data_demand_DHW={'Model':['Contracting_model'],'Scenario':['Contracting_1'],'Region':'Demand DHW','Variable':['Demand - DHW'],'Unit':['kW'],
...
data_demand_electricity={'Model':['Contracting_model'],'Scenario':['Contracting_1'],'Region':'Demand Electricity','Variable':['Demand - Electricity'],'Unit':['kW'],
...
pd.concat([df_supply_PV_contractor,df_supply_PV_to_Grid,df_supply_PV_to_Household,df_demand_charging,df_supply_PV_to_Car,df_demand_shifted,df_data_supply_Grid_to_Car,df_supply_PV_to_HP]).to_csv(str(output_file_path),index=False)
...
# df = pd.DataFrame({'Capacity Contractor': capacity_Contractor,
#                    'Capacity Self financed': capacity_Self_financed }, index=index)
# ax = df.plot.bar(rot=0)
# ax.set_ylabel('kW/m²/psc')
# ax.set_xlabel('New Technology investments')
# plt.show()
