...
def read_data():
    ...
    for key in dict_capacity_f:
        dict_capacity_factor_var_supply[key] = dict_capacity_factor_var_supply[key] *param_area_pv
...
dict_capacity_f = dict_irradiation.copy() 
for key in dict_capacity_f:
    dict_capacity_f[key] = dict_capacity_f[key] *param_area_pv



dict_capacity_grid= dict()
for k1 in set_time :
    for k2 in set_options_fix_supply:
        dict_capacity_grid[k1,k2] = param_capacity_factor_grid
        


ndic = {**dict_capacity_grid, **dict_capacity_f}
print('ndic: ', ndic)

print('dict_capacity_grid: ', dict_capacity_grid)
print('dict_capacity_f: ', dict_capacity_f)
